package com.example.androidStudio_asynctask_20;
...
public class MainActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    public void onClick(View v) {
        new downloadimg().execute("https://vthumb.ykimg.com/054101015DFCAFFF1B4D0797AA5B3346");
    ...
    private  class  downloadimg extends AsyncTask<String, Integer, Bitmap>{
        ...
        protected void onPostExecute(Bitmap bitmap) {
            if (bitmap != null){
                ...
                Toast.makeText(getApplicationContext(), "Futurrrrrrrrrre",
